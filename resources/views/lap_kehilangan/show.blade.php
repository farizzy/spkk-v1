    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">{{ $lap_kehilangan->no_surat_hilang }}</div>
            ...
            <div><b>Komentar:</b></div>
                <?php $komentar = DB::table('saran_komentar')
                        ...
                        ->whereRaw('lap_kehilangan.id_lap_kehilangan = ?', [$lap_kehilangan->id_lap_kehilangan])
                        ->get(); 
                    $pengirim = Auth::user()->name;
                    $idpengirim = Auth::user()->id;
                    $idlaporan = $lap_kehilangan->id_lap_kehilangan;
                        ?>
