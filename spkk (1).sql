...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2017 at 07:10 AM
...
CREATE TABLE `beritas` (
  ...
  `judul_gambar` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(6, 'drtg', '2017-06-22 04:26:40', '2017-06-22 04:26:40', 'fghdgjgfjfhj', 'AceofSpades.png', NULL, '44977', 'image/png'),
(7, 'Buka bersama PT. eternit gresik', '2017-06-24 04:49:38', '2017-06-24 04:49:38', 'Lorem ipsum', '8109.jpg', NULL, '2523934', 'image/jpeg');
...
INSERT INTO `lap_kehilangan` (`id_lap_kehilangan`, `created_at`, `updated_at`, `no_surat_hilang`, `id_daerah`, `id_pendaftaran`, `no_polisi`, `jenis_kendaraan`, `merk_kendaraan`, `warna_kendaraan`, `no_mesin`, `tanggal_hilang`, `keterangan`, `status`) VALUES
(1, NULL, '2017-07-03 19:54:59', 'ABE/260589/001', 1, 3, 'DS 1234 AS', 'MOTOR', 'SUZUKI', 'HITAM', '09213', '2017-05-26', 'HILANG DIDEPAN WARUNG MAKAN SEDERHANA', 1),
(7, '2017-05-28 06:13:09', '2017-05-28 06:13:09', 'lpkh/2017/05/1', 1, 1, 'DS 1234 SA', 'Motor', 'Suzuki', 'Hitam', '', '2017-05-28', 'asdasd', 0),
(8, '2017-05-28 06:18:39', '2017-05-28 06:18:39', 'lpkh/2017/05/2', 2, 1, 'DS 5642 SA', 'Mobil', 'Toyota', 'Putih', 'ads2we423', '2017-05-26', 'fertgg', 0),
(9, '2017-05-28 06:26:34', '2017-05-28 06:26:34', 'lphk/2017/05/9', 3, 1, 'DS 5654 SA', 'Motor', 'Toyota', 'Putih', 'rwh456', '2017-05-25', 'adf rthe eyrt rew2t4 ewgrg', 0),
(10, '2017-05-28 06:54:44', '2017-05-28 06:54:44', 'LPHK/2017/05/5', 1, 1, 'AB 43234 S', 'Motor', 'Yamah', 'Hitam', 'ferer32', '2017-05-20', 'asdasdasdasdfsdfasdf', 0),
(11, '2017-05-28 07:23:44', '2017-05-28 07:23:44', 'LPHK/2017/05/6', 2, 3, 'B 3112 SIA', 'Motor', 'Honda', 'Kuning', 'kdao34e', '2017-05-28', 'afasgerdg', 0),
(15, '2017-06-01 18:25:23', '2017-07-03 19:53:51', 'LPHK/2017/06/1', 1, 3, 'DS 2921 BD', 'Motor', 'Honda', 'Hitam', 'fwerwer', '2017-06-02', 'yrdy', 0),
(16, '2017-06-08 19:34:50', '2017-06-08 19:34:50', 'LPHK/2017/06/2', 4, 1, 'de', 'wfsd', 'asd', 'dsfd', 'wer', '2017-06-09', 'dsasd', 0);
...
CREATE TABLE `penemuan` (
  ...
  `status_penemuan` tinyint(1) NOT NULL DEFAULT '0',
  `nama_pengambil` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `penemuan` (`id_penemuan`, `created_at`, `updated_at`, `id_lap_kehilangan`, `no_polisi_temuan`, `tanggal_temuan`, `foto`, `jenis_temuan`, `merk_temuan`, `warna_temuan`, `no_mesin_temuan`, `deskripsi_temuan`, `status_penemuan`, `nama_pengambil`, `tgl_diambil`) VALUES
(19, '2017-07-03 20:07:10', '2017-07-03 20:07:39', 1, 'DS 1234 AS', '2017-07-04', '', 'MOTOR', 'SUZUKI', 'HITAM', '09213', 'a', 1, 'saya', '2017-07-04');
...
(19, 1, 1, 'coba', NULL, NULL),
(20, 1, 3, 'kenape', NULL, NULL),
(21, 1, 3, 'test', NULL, NULL),
(22, 7, 5, 'uwoooo', NULL, NULL),
(23, 7, 1, 'oiy', NULL, NULL),
(24, 1, 1, 'percobaan\r\nbanyak line', NULL, NULL),
(25, 1, 1, 'rrd', NULL, NULL);
...
(1, 'Administrator', 'administrator', '$2y$10$wAPSJW5KqeL1tCmJbrysceSaty.NgBC6SB0tNjagDmNhaJdwUDd8y', 'admin@yahoo.com', '', '', 1, '6jQ4NPWdcG3vNGkz3kdufDzmMFwRESYn6g5DivXecP8kYLioaA5FsQeJgusv', NULL, NULL),
(3, 'Budi Anduk', 'budi', '$2y$10$pQsYJ13qp9HRqMdlaSuVrOAt5Eu/tPYbmVbGCllhVnOpLq/YGIyEO', 'budi.anduk@yahoo.com', 'Laki-Laki', 'jauh coy', 0, 'hDYMJu2vvvYcstOFhHJcDqlrVMH7WHGMgXtpovmOHtFQTlIHzndA1TCiZbP3', NULL, NULL),
(4, 'ANI', 'ANI SIAN', 'aaaaaa', 'ani@yahoo.com', 'Perempuan', 'Kotaraja', 0, NULL, NULL, NULL),
(5, 'user', 'user', '$2y$10$eKRvlc6oA3vsw4vybVwD/OD9pR64WD0vKOJJ7dslFOI.aK5DMy4V.', 'user@yahoo.com', 'Laki-Laki', 'user', 0, 'lWRlTAlUWhKegZUBQy2lB2R1FG1o7WScP7n569pRsLWNJweOGoPpoLS9jsC1', NULL, NULL);
...
--
ALTER TABLE `penemuan`
  MODIFY `id_penemuan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
